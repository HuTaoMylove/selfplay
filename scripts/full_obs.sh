...
CUDA_VISIBLE_DEVICES=1 python render/render_jsbsim.py \
    ...
    --seed ${seed} --n-training-threads 1 --n-rollout-threads 32 --cpu --log-interval 1 --save-interval 1 \
    ...
    --model-dir "C:/Users/22758/Desktop/机战/CloseAirCombat-master/scripts/results/SingleCombat/1v1/NoWeapon/Selfplay/ppo/v1/run1"
